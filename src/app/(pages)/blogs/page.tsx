  ...
  return (
    <>
      ...
      <div className="relative w-full flex flex-col justify-center items-center mx-auto">
        <div className="sticky w-9/12 max-md:w-full max-md:px-4 top-0 py-14 max-md:pt-28 pt-36 max-md:pb-5">
        ...
        <div className=" w-9/12 max-md:w-full z-10 ">
          <div className="grid grid-cols-2 gap-10 max-md:gap-0 max-md:grid-cols-1">
            {blogs.map((data, i) => (
              <BlogCard
