...
function JoinTeam() {
  return (
    <div className=" w-10/12 uppercase rounded-3xl pt-24 mt-4 bg-cuGreen leading-ms tracking-ms text-center flex flex-col items-center justify-center font-extrabold relative text-7xl">
