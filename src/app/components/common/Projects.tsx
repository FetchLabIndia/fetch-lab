...
export default function Project() {
  return (
    <div className=" flex items-center w-full  justify-center  py-7">
      <div className=" bg-cuPurple font-extrabold max-md:px-1 text-8xl max-md:text-6xl rounded-3xl text-white w-10/12 flex-col flex text-center justify-center items-center h-[380px] max-md:h-[200px] leading-ms tracking-ms">
