...
function HelloThere() {
  return (
    <div className=" flex p-7 flex-wrap pt-40 text-white w-full justify-center gap-11">
      ...
      <p className=" w-1/2 max-md:w-full max-md:text-lg max-md:text-center font-light text-xl font-sofiaSans">
